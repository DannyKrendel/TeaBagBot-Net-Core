...
namespace TeaBagBot.Attributes
{
    ...
    {
        public DescriptionAttribute([CallerMemberName] string memberName = "")
            : base(TeaBagCommandService.GetCommand<MongoRepository<TeaBagCommand>>(memberName).Description)
        {
